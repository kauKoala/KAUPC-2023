      ...
      <S.Root>
        <ListContainer>
          ...
          <div className="container">
            ...
            <li>본 대회는 개인전으로 진행되며, 약 5시간동안 주어진 프로그래밍 문제를 해결하는 대회입니다.</li>
            <li>인터넷 검색을 이용하거나 미리 준비하는 코드를 사용해도 됩니다. 다만 chatGPT 사용은 금지되며, 적발 시 퇴장될 수 있습니다.</li>
            ...
            <li>문제는 총 10문제로, 백준 기준 브론즈~플래티넘 수준에서 출제됩니다.</li>
            <SubTitle title='📣 유의사항'>
              {/* <RiErrorWarningLine /> */}
            </SubTitle>
            <li>chatGPT의 사용은 금지됩니다.적발 시 퇴장될 수 있으니 주의바랍니다</li>
